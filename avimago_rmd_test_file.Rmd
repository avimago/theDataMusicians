...
After plotting and observing, graphs that shows interesting trends are presented below. 
...
## Hypothesis Test
Through graphical observation, some variables that influence attrition have been identified. In this section, hypothesis test is applied to these variables to further investigate their relevance to attrition. 
```{r}
