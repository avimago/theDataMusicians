...
full_model_reg_try<-glm(Attrition~BusinessTravel+OverTime,data = IBM_Sqr, family= binomial)
 
or_glm(data = IBM_Sqr, model = full_model_reg_try, 
       incr = list(OverTime = 1 , CI = 0.95))


stargazer(list(simple_model_2,simple_model_3,simple_model_4), type = "text")


model_reg_performance<-glm(Attrition~JobInvolvement+OverTime+PercentSalaryHike+PerformanceRating+TrainingTimesLastYear+YearsAtCompany+YearsInCurrentRole+YearsSinceLastPromotion+YearsWithCurrManager+TotalSatisfaction,data = IBM_Sqr, family= binomial)

summary(model_reg_performance)

or_glm(data = IBM_Sqr, model = model_reg_performance, incr = list(TotalSatisfaction = 1 , CI = 0.95))
...
full_model_reg<-glm(Attrition~,data = IBM_Sqr, family= binomial)

 
or_glm(data = IBM_Sqr, model = full_model_reg, incr = list(TotalSatisfaction = 1, DistanceFromHome =5, NumCompaniesWorked = 1 , TotalWorkingYears = 5, DailyRate = 10, HourlyRate = 100, MonthlyIncome = 1000, PercentSalaryHike = 1, TotalWorkingYears = 1, TrainingTimesLastYear = 1, YearsAtCompany = 1, CI = 0.95))
