...
or_glm(data = IBM_Sqr, model = model_reg_performance, 
       incr = list(TotalSatisfaction = 1 , CI = 0.95))
...
or_glm(data = IBM_Sqr, model = full_model_reg, 
       incr = list(TotalSatisfaction = 1, DistanceFromHome =5, NumCompaniesWorked = 1 , TotalWorkingYears = 5, DailyRate = 10, HourlyRate = 100, MonthlyIncome = 1000, PercentSalaryHike = 1, TotalWorkingYears = 1, TrainingTimesLastYear = 1, YearsAtCompany = 1, CI = 0.95))
