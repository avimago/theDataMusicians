...
In this section, the distribution of the different variable are plotted and observed. The aim is to discover discrpancies between the employees that left the company, which has 'yes' in the 'Attrition column'. 
